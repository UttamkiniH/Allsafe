...
class Hospital {
  ...
  Hospital copyWith({
    ...
    return Hospital(
      ...
      available_beds_without_oxygen:
          available_beds_without_oxygen ?? this.available_beds_without_oxygen,
      available_beds_with_oxygen:
          available_beds_with_oxygen ?? this.available_beds_with_oxygen,
  ...
  factory Hospital.fromMap(Map<String, dynamic> map) {
    ...
    return Hospital(
      ...
      available_icu_beds_without_ventilator:
          map['available_icu_beds_without_ventilator'],
      available_icu_beds_with_ventilator:
          map['available_icu_beds_with_ventilator'],
  ...
  bool operator ==(Object other) {
    ...
    return other is Hospital &&
        ...
        other.available_icu_beds_without_ventilator ==
            available_icu_beds_without_ventilator &&
        other.available_icu_beds_with_ventilator ==
            available_icu_beds_with_ventilator &&
